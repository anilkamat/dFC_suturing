...
PATH = r'C:\Users\_Kamat_\Desktop\RPI\ResearchWork\Papers_\Effective_Connectivity\EEG_fNIRS_paper_Brain_informatics\EEG_codes_results\GC_regional_Jun10\Connectivities'
...
for kernel_ in model_para_grid['kernel']:
  for gamma_ in model_para_grid['gamma']:
    for c_ in model_para_grid['c']:
      if kernel_ == 'linear':
        svclassifier = SVC(kernel=kernel_,random_state=1, C=c_)#, gamma=100, C=0.1,random_state=1,) # ,
      else:
...
# test_acc ={}
  ...
  #df2.columns = i
  #df1 = df1.transpose()
  FullFilename2 = os.path.join(PATH2,trial+'all'+'.csv')
  df3.to_csv(FullFilename2)

trialandST = ['T1ST1',	'T1ST2',	'T1ST3',	'T1ST4',	'T1ST5',	'T1ST6',	'T1ST7',	'T1ST8',	'T1ST9',	'T1ST10',	'T1ST11',	'T1ST12','T1ST13',
              'T2ST1',	'T2ST2',	'T2ST3',	'T2ST4',	'T2ST5',	'T2ST6',	'T2ST7',	'T2ST8',	'T2ST9',	'T2ST10',	'T2ST11',	'T2ST12',	'T2ST13',
              'T3ST1',	'T3ST2',	'T3ST3','	T3ST4',	'T3ST5',	'T3ST6',	'T3ST7',	'T3ST8',	'T3ST9',	'T3ST10',	'T3ST11',	'T3ST12',	'T3ST13']
PATH3 = r'C:\Users\_Kamat_\Desktop\RPI\ResearchWork\Papers_\Effective_Connectivity\EEG_fNIRS_paper_Brain_informatics\EEG_codes_results\GC_Results_Jun10\SVM_results'
filename1 = os.path.join(PATH3,'Results.xlsx')
sheets=['Tr_1','Tr_2','Tr_3']
#ranked = rankVariable(filename1,sheets)


#file = os.path.join(r'C:\Users\_Kamat_\Desktop\RPI\ResearchWork\Papers_\Effective_Connectivity\EEG_fNIRS_paper_Brain_informatics\EEG_codes_results\GC_Results_Jun10','EEG_GC_regional_HTA_06212022.mat')
#GC_workspc = sio.loadmat(file)
#sorted(GC_workspc.keys())
#stat_analysis(GC_workspc)