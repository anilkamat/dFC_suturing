...
import pandas as pd
import pickle
from plot_mesh_grid_08192022 import plot_ROC
...
def grid_search( data, config_subtask, config, set_number,savePath_results, Type = 'add_connectivity'):
    ...
    if Type == 'all_connectivity':
        ...
        for m in range(20):  # for feature/connectivity added datasets.
            ModelName = 'add_connectivity_'+Day+trial
            ...
            for c_ in model_para_grid['c']:
                ...
                if Type=='all_connectivity':
                    ...
                    if (acc_test_CV_mean > best_model_[ModelName+'test_acc_CV']) :
                        ...
                        # Receiver operating curve is not ploted here as this analysis is LOOCV i.e. has only one test sample
